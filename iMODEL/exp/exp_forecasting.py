...
class Exp_Long_Term_Forecast1(Exp_Basic):
    ...
    def test(self, setting, test=0):
        ...
        if test:
            print('loading model')
            self.model.load_state_dict(torch.load(os.path.join('checkpoint\iMODEL\UL-NCA\CY45-05_1\iMODEL_dsNCA_ex5_pl50_tk2_ep2000_dm0\checkpoint.pth')))
        self.model.eval()
